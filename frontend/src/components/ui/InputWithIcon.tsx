  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative mt-1">
            ...
            <input ref={ref} {...props} type={type === "password" ? (showPassword ? "text" : "password") : type} className={`pl-12 h-11 w-full rounded-xl text-sm border border-line focus:border-primary ${props.className}`} />
